 ...
 *
 */
class Mfolio_Portfolio_Gallery extends Widget_Base {

	public function get_name() {
		return 'mfolioportfoliogallery';
	}

	public function get_title() {
		return esc_html__( 'Portfolio Gallery', 'mfolio-lite' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			'portfolio_gallery_pro_section',
			[
				'label' => esc_html__( 'Go Premium For Portfolio Gallery', 'mfolio-lite' ),
			]
        );
