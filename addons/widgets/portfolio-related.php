 ...
 *
 */
class Mfolio_Portfolio_Related extends Widget_Base {

	public function get_name() {
		return 'mfolioportfoliorelated';
	}

	public function get_title() {
		return esc_html__( 'Related Portfolio', 'mfolio-lite' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'portfolio_related_section',
			[
				'label'     => esc_html__( 'Related Portfolio', 'mfolio-lite' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'condition'     => [ 'portfolio_related_style' => ['1','3'] ]
            ]
        );
		$this->add_control(
			'portfolio_column',
		...
		$this->add_control(
			...
			[
				...
				'condition'		=> [ 'portfolio_related_style' => '3' ],
			]
        );
		...
		$this->add_control(
			...
			[
				...
				'condition'		=> [ 'portfolio_related_style'	=> '1' ]
			]
        );
        ...
        $this->add_control(
			...
			[
				...
				'condition'		=> [ 'portfolio_related_style'	=> '4' ]
			]
        );
        ...
        $this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .portfolio_item .portfolio_info .cat-links a,{{WRAPPER}} .portfolio_item .portfolio_info .cat-links,{{WRAPPER}} .project-item.agency .project-info p' => 'color: {{VALUE}}',
                ],
			]
        );
        ...
        $this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .portfolio_item .portfolio_info .cat-links a:hover,{{WRAPPER}} .portfolio_item .portfolio_info .cat-links:hover,{{WRAPPER}} .project-item.agency .project-info p' => 'color: {{VALUE}}',
                ],
				'condition'		=> [ 'portfolio_related_style!'	=> '1' ]
			]
        );
        ...
        $this->add_group_control(
			...
			[
                ...
                'selector' 	=> '{{WRAPPER}} .portfolio_item .portfolio_info .cat-links a,{{WRAPPER}} .portfolio_item .portfolio_info .cat-links,{{WRAPPER}} .project-item.agency .project-info p',
			]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' 		=> [ 'px', '%', 'em' ],
				'selectors' 		=> [
					'{{WRAPPER}} .portfolio_item .portfolio_info .cat-links a,{{WRAPPER}} .portfolio_item .portfolio_info .cat-links,{{WRAPPER}} .project-item.agency .project-info p' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
			]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', '%', 'em' ],
				'selectors' 	=> [
					'{{WRAPPER}} .portfolio_item .portfolio_info .cat-links a,{{WRAPPER}} .portfolio_item .portfolio_info .cat-links,{{WRAPPER}} .project-item.agency .project-info p' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
			]
		);
	...
	protected function render() {
        ...
        if( !empty( $settings['exclude_cats'] ) && empty( $settings['exclude_tags'] ) && empty( $settings['exclude_post_id'] ) ) {
            $args = array(
                'post_type'         	=> 'mfolio_portfolio',
                'posts_per_page'    	=> esc_attr( $settings['portfolio_related_count'] ),
                'order'             	=> esc_attr( $settings['portfolio_related_order'] ),
                'orderby'           	=> esc_attr( $settings['portfolio_related_order_by'] ),
        ...
        if( $portfoliogrid->have_posts() ) {
			...
			if( $settings['portfolio_related_style'] == '2' ){
                            ...
                            if( has_post_thumbnail() ){
                                echo '<div class="portfolio_image">';
                                    echo '<a href="'.esc_url( get_the_permalink() ).'">';
                                        the_post_thumbnail( 'mfolio_related_portfolio' );
                                    echo '</a>';
                                echo '</div>';
                            }
