 ...
 *
 */
class Mfolio_Portfolio_Double_Image extends Widget_Base {

	public function get_name() {
		return 'mfolioportfoliodoubleimage';
	}

	public function get_title() {
		return esc_html__( 'Portfolio Double Image', 'mfolio-lite' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Go Premium For Double Image', 'mfolio-lite' ),
			]
        );
