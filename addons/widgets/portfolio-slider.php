 ...
 *
 */
class Mfolio_Portfolio_Slider extends Widget_Base {

	public function get_name() {
		return 'mfolioportfolioslider';
	}

	public function get_title() {
		return esc_html__( 'Portfolio Slider', 'mfolio-lite' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			'portfolio_slider_pro_section',
			[
				'label' => esc_html__( 'Go Premium For Portfolio Slider', 'mfolio-lite' ),
			]
        );
